...
class multi_ue(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._cell_gain4_win = RangeWidget(self._cell_gain4_range, self.set_cell_gain4, 'cell_gain4', "counter_slider", float)
        self.top_grid_layout.addWidget(self._cell_gain4_win)
        self._cell_gain3_range = Range(min_gain, max_gain, 0.0001, 0.04, 200)
        self._cell_gain3_win = RangeWidget(self._cell_gain3_range, self.set_cell_gain3, 'cell_gain3', "counter_slider", float)
        self.top_grid_layout.addWidget(self._cell_gain3_win)
